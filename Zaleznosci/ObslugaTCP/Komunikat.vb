...
Friend Class TypKomunikatu
    ...
    Private Shared ReadOnly KOMUNIKATY_OBSERWATORA As New HashSet(Of UShort) From {ZMIENIONO_STAN_TORU, ZMIENIONO_STAN_ZWROTNICY, ZMIENIONO_STAN_SYGNALIZATORA, ZMIENIONO_KIERUNEK, ZMIENIONO_STAN_PRZEJAZDU}
